...
(def bitrate "96k")
(def string-stream-twitch (str "ffmpeg -f concat -i list.txt -f alsa -i pulse -map 0:v -map 1:a -c:v copy -c:a aac -ar 44100 -b:a 96k -f flv rtmp://" platform-twitch streamkey-twitch))
